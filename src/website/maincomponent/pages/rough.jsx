    ...
    http
      ...
      .then((res) => {
        ...
        cartData.forEach((el) => {
          ...
          productQtys.push(el.cart_product_qty);
          productPrices.push(el.online_price);
          productDiscounts.push(el.discount);
          productPvValues.push(el.point_value);
          productTotals.push(el.cart_price);
          productGsts.push(el.gst);
        });
        ...
        setOrder((prevOrder) => ({
          ...
          gst: productGsts, // An array of GST values
        }));
        setCart(cartData);
      })
      .catch((e) => {
                  ...
                  <table className="table">
                    ...
                    <tfoot>
                      ...
                      <tr className="cart-subtotal">
                        ...
                        <td>
                          <span className="amount">&#8377;{pv.toFixed(2)}</span>
                        </td>
                      </tr>
                      <tr className="cart-subtotal">
                        <th>Cart Discount</th>
